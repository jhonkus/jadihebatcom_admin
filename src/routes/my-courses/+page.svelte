		...
		{#if data.error}
			<!-- Error State -->
				...
				<div>
					<strong>Oops!</strong>
					{data.error}
					<a href="/my-courses" class="btn btn-sm btn-outline-danger ms-3"> Coba Lagi </a>
				</div>
			</div>
		{:else if data.enrollments.length === 0}
			<!-- Empty State -->
				...
				<p class="empty-text">Mulai perjalanan belajar Anda dengan memilih kursus yang menarik</p>
					<a href="/courses" class="btn btn-primary btn-lg gradient-btn">
						...
						<div class="col-lg-6">
							<div class="course-card">
								...
								<div class="course-card-footer">
									<a
										href="/courses/{(enrollment.course_id as any).slug}"
									...
									<a
										href="/learning/{(enrollment.course_id as any).slug}"
										class="btn btn-primary gradient-btn"
									>
